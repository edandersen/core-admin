...
namespace DotNetEd.CoreAdmin.Controllers
{
    ...
    public class CoreAdminDataController : Controller
    {
        ...
        private IEnumerable<string> GetFieldsToIgnore(object entity)
        {
            var fieldsToIgnore = entity.GetType().GetProperties()
                .Where(p => p.GetCustomAttributes().Any(a =>
                {
                    if (a.GetType().Name.Contains("DatabaseGenerated"))
                    {
                        return true;
                    }
                    else if (a.GetType().Name.Contains("DisplayAttribute"))
                    {
                        return !(((DisplayAttribute)a).GetAutoGenerateField()) ?? false;
                    }
        ...
        public async Task<IActionResult> CreateEntityPost(string dbSetName, string id, [FromForm] object formData)
        {
            ...
            var toIgnore = GetFieldsToIgnore(newEntity);
            ...
            await TryUpdateModelAsync(newEntity, entityType, string.Empty,
                ...
                (ModelMetadata meta) => !toIgnore.Contains(meta.PropertyName));
            ...
            ViewBag.IgnoreFromForm = toIgnore;
        ...
        public IActionResult Create(string id)
        {
            ...
            ViewBag.IgnoreFromForm = GetFieldsToIgnore(newEntity);
            ViewBag.Relationships = relationships;
        ...
        public IActionResult EditEntity(string dbSetName, string id)
        {
            ...
            ViewBag.Id = id;
            ViewBag.Relationships = relationships;
            ViewBag.IgnoreFromForm = GetFieldsToIgnore(entityToEdit);
        ...
        public async Task<IActionResult> EditEntityPost(string dbSetName, string id, [FromForm] object formData)
        {
            ...
            var toIgnore = GetFieldsToIgnore(entityToEdit);
